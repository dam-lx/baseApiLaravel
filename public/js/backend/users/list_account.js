...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["d"] = notify;
/* unused harmony export getUrlParameter */
/* harmony export (immutable) */ __webpack_exports__["a"] = buildList;
/* unused harmony export showEmpty */
/* harmony export (immutable) */ __webpack_exports__["b"] = buildPaginate;
/* harmony export (immutable) */ __webpack_exports__["e"] = saveStoragePage;
/* harmony export (immutable) */ __webpack_exports__["c"] = clearStoragePage;
/* unused harmony export getStoragePage */
/* unused harmony export checkImg */
//==================================function notify===========================
...
function buildList(data, map_field, strParam) {
...
function showEmpty(data, map_field, strParam) {
    var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "default";
...
function buildPaginate(target, startPage, total_pages, urlPage, strParam, map_field) {
    var type = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : "default";
    ...
    $(target).twbsPagination({
        ...
        next: _textNext,
        last: _textLast,
        onPageClick: function onPageClick(event, page, total_page) {
...
function saveStoragePage(key, value) {
    sessionStorage.setItem(key, value);
}

function clearStoragePage(key) {
    sessionStorage.removeItem(key);
}

function getStoragePage(key) {
...
function checkImg(files, classError, titleTrans) {
    try {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_common_function__ = __webpack_require__(143);
...
var toastr = __webpack_require__(8);
//=====================variables================================
var _isLoading = 0;
...
$(document).on("click", ".edit ", function () {
    ...
    path_param != "" ? Object(__WEBPACK_IMPORTED_MODULE_0__lib_common_function__["e" /* saveStoragePage */])("path_param", path_param) : Object(__WEBPACK_IMPORTED_MODULE_0__lib_common_function__["c" /* clearStoragePage */])("path_param");
...
function getList(page, search) {
    ...
    $.ajax({
        ...
        success: function success(data) {
            if (data.status == _statusOK) {
                Object(__WEBPACK_IMPORTED_MODULE_0__lib_common_function__["a" /* buildList */])(data, map_field, strParam, "user");
                Object(__WEBPACK_IMPORTED_MODULE_0__lib_common_function__["b" /* buildPaginate */])('#pagination-demo', page, data.data.last_page, routePage, strParam, map_field, "user");
            } else {
                notify(_error, 'error', data.message, '#AA3131', '#792A2A');
            }
        },
