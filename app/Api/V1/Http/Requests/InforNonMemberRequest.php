...
class InforNonMemberRequest extends ApiRequest
{
    /**
    ...
    {
            return [
                'order_id'          => 'required|regex:' . UserConst::VALIDATE_INTERGER,
                ...
                'kana01' => 'nullable|max:25|regex:' . UserConst::VALIDATE_KANA,
                'kana02' => 'nullable|max:25|regex:' . UserConst::VALIDATE_KANA,
